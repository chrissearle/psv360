...
const showPanoTitle = computed(() => route.path.startsWith('/pano/') && !!panoTitle.value)
</script>

<template>
  <div class="min-h-screen flex flex-col">
    <header class="border-b border-neutral-800 px-6 py-4 grid grid-cols-3 items-center">
      <div class="flex items-center gap-3">
        ...
        <NuxtLink to="/" class="text-xl font-semibold tracking-tight hover:text-primary transition-colors">
          360° Panoramas
        </NuxtLink>
      </div>
